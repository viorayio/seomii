          ...
          <div class="col-md-6 pb-2 pb-sm-0 mb-4 mb-sm-5 mb-md-0">
            ...
            <div class="binded-content bg-primary rounded-5">
              ...
              <div class="binded-item active" id="image1">
                ...
                </svg><img class="d-block position-relative zindex-2" src="assets/img/landing/mobile-app-showcase/features/01.png" alt="App screen">
              </div>
              <!-- Item-->
              <div class="binded-item" id="image2">
                ...
                </svg><img class="d-block position-relative zindex-2" src="assets/img/landing/mobile-app-showcase/features/02.png" alt="App screen">
              </div>
              <!-- Item-->
              <div class="binded-item" id="image3">
                ...
                </svg><img class="d-block position-relative zindex-2" src="assets/img/landing/mobile-app-showcase/features/03.png" alt="App screen">
              </div>
            </div>
          </div>
